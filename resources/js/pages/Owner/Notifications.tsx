// resources/js/pages/Owner/Notifications.tsx
...
import { PageHeader, EmptyState, Pagination, toastSuccess, C } from '@/pages/Owner/_shared/OwnerUI';
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        {loading ? (
                            ...
                            <div className="divide-y divide-gray-50">
                                {items.map(n => (
                                    <Link key={n.id} href={`/owner/notifications/${n.id}`} onClick={() => handleOpen(n)}
                                        className={`flex items-start gap-3 px-5 py-3.5 hover:bg-gray-50 transition-colors ${!n.is_read ? 'bg-sky-50/40' : ''}`}>
