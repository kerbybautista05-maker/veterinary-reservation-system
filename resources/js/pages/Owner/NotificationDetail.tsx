// resources/js/pages/Owner/NotificationDetail.tsx
...
export default function OwnerNotificationDetail({ notificationId }: { notificationId: number | string }) {
        ...
        <AppLayout>
            ...
            <div className="min-h-screen" style={{ background: C.bg }}>
                ...
                <div className="max-w-xl mx-auto px-4 sm:px-6 py-6">
                    <BackLink href="/owner/notifications" label="Back to Notifications" />

                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        <p className="text-[11px] font-bold uppercase tracking-wide" style={{ color: C.sky }}>{notification.type.replace(/_/g, ' ')}</p>
                        ...
                        {notification.deep_link && (
                            <Link href={notification.deep_link} className="inline-flex items-center gap-1.5 mt-5 px-4 py-2.5 rounded-xl text-white text-sm font-bold" style={{ background: C.sky }}>
